...
class RequestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requester" do
    assert_difference('Requester.count') do
      post requesters_url, params: { requester: { city: @requester.city, cpf: @requester.cpf, email: @requester.email, fenced_plot: @requester.fenced_plot, identify: @requester.identify, name: @requester.name, number: @requester.number, phone: @requester.phone, referency_point: @requester.referency_point, residence: @requester.residence, sector: @requester.sector, street: @requester.street, zip: @requester.zip } }
    end
