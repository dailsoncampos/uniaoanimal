...
class AdoptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adoption" do
    assert_difference('Adoption.count') do
      post adoptions_url, params: { adoption: { animal_id: @adoption.animal_id, requesters_id: @adoption.requesters_id, status: @adoption.status } }
    end
  ...
  test "should update adoption" do
    patch adoption_url(@adoption), params: { adoption: { animal_id: @adoption.animal_id, requesters_id: @adoption.requesters_id, status: @adoption.status } }
