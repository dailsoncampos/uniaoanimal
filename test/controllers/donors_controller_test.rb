...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post donors_url, params: { donor: { donation: @donor.donation, email: @donor.email, message: @donor.message, name: @donor.name, phone: @donor.phone } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { donation: @donor.donation, email: @donor.email, message: @donor.message, name: @donor.name, phone: @donor.phone } }
